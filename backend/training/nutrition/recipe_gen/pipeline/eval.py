...
# FitNova patch (2026-05-29): heavy eval/preprocessing deps are made lazy/optional so
# the decode helpers (top_k_logits, top_p_logits, sample_next_token) can be imported
# without installing nltk/pyrouge/spacy locally. Colab installs them in the training
# notebook; functions that need them will fail informatively if called without them.
try:
