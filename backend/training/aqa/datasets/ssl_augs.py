...
def zoom(
    ...
    *,
    ...
    Magnitude kept small per RESEARCH §7 — aggressive zoom changes apparent squat depth
    (the KFE cue). [§7]
    """
...
def rotation(
    ...
    *,
    ...
    not regress (RESEARCH §7). Clip-consistent, NEAREST + zero fill → uint8 preserved. [§7]
    """
