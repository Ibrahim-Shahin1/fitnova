"""Unit tests for OHP SSL dataset: trajectory loader (OHP-01-b) and half-cycle splitter (OHP-01-c).

See: .planning/phases/06-overhead-press/06-01-PLAN.md — Tasks 3/4 / RESEARCH §3 / T-06-01 / T-06-02.
"""
...
# ──────────────────────────────────────────────────────────────────────────────
# OHP-01-b: BBox _load_trajectory (T-06-01 mitigation)
# ──────────────────────────────────────────────────────────────────────────────


def test_trajectory_load(tmp_path: Path) -> None:
    """OHP-01-b: BBox JSON with 2 empty region-0 frames is interpolated correctly.
    ...
    # y_center = (y1+y2)/2 per ReadMe formula (RESEARCH §3)
...
# ──────────────────────────────────────────────────────────────────────────────
# OHP-01-c: split_half_cycles argMIN guard on synthetic V-trajectory (T-06-02 mitigation)
# ──────────────────────────────────────────────────────────────────────────────


def test_split_half_cycles_ohp() -> None:
    """OHP-01-c: split_half_cycles with bottom_is_argmax=False correctly splits a V-trajectory.
    ...
    # This proves the sign param is wired and argMIN is the correct OHP choice (Pitfall 2).
