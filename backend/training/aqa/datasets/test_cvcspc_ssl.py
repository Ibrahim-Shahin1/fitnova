"""Unit tests for the CVCSPC SSL cores — the 3-term loss (closed-form + directionality)
and the projection head, plus the phase-matched triplet / _traj2phase / masking / traj_nan tests."""
