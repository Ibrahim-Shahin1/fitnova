"""ResNet-18 supervised image trainer for Shallow-Squat depth-error detection (IMG-02).
...
The ``model_builder`` seam on ``run_image_epoch`` lets the CVCSPC fine-tune (Plan 04) inject a
