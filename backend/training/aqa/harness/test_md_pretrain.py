"""Unit tests for md_pretrain.py + squat_ssl.split_half_cycles.

Pure-function verification of the reconstructed-from-paper logic before the
12-24h GPU burn: the half-cycle splitter, the triplet distance-ratio loss
arithmetic, the projector L2-norm, the model build, and the SSL checkpoint
schema.
"""
