"""Multi-seed ensemble aggregation for the MD-SSL model.
...
unchanged; this module only aggregates score arrays.
"""
...
def aggregate_sigmoid_mean(per_seed_logits: list[np.ndarray]) -> np.ndarray:
    """Mean of per-seed sigmoid scores across seeds (mean-of-sigmoids).
    ...
    # Mean of SIGMOIDS (NOT mean of logits). The [0,1] output satisfies the
