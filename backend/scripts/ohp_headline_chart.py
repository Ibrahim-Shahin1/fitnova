"""Headline OHP F1-vs-paper comparison chart.

Numbers from the test eval on the official 339-clip OHP test split
(2-seed MD-SSL ensemble, val-tuned thresholds, no TTA). The full figure pack
(PR / confusion / training curves) is regenerated from results.pkl.
"""
