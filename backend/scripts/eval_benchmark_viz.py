...
# Production thresholds (validation-tuned).
KIE_THR, KFE_THR = 0.614, 0.385

# Published comparison points (Parmar et al., ECCV 2022).
PAPER = {
    "KFE": {"Kinetics baseline": 0.818, "MD-SSL (paper)": 0.834},
    "KIE": {"Kinetics baseline": 0.297, "MD-SSL (paper)": 0.419},
}
# Official test-split numbers (Colab eval, torchvision decode) — the headline academic number.
...
def fig_f1_vs_paper():
    ...
    b1 = ax.bar(x - w, ours, w, label="Ours (MD-SSL)", color="#1B998B")
