...
Usage:
    ...
    If --out is not given, the figure is saved to a default figures/ path.

Requires staged weights in backend/models/form_model_squat_md/.
...
_DEFAULT_OUT = _REPO_ROOT / "docs" / "figures" / "squat_result_overlay.png"
