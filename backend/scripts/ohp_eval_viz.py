"""OHP evaluation + training figure pack, built from results.pkl.

SSL convergence (loss + effective_rank + linear-probe), PR curves, confusion matrices,
ensemble score distributions — all from results.pkl (real test scores on the
...
PKL = Path("backend/data/benchmark/ohp/results.pkl")
